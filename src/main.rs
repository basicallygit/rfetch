...
'-----------------'";
        ...
        info.push(format!("{}: {}G / {}G", style("MEM").color256(119), sys.used_memory()/1024/1024, sys.total_memory()/1024/1024));
        info.push(format!("{}: {}h", style("UP").color256(111), sys.uptime()/60/60));
